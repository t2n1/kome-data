...
|---|---|---|---|
| **Nạp nhầm file** (nhầm ngày, nhầm file, nạp trùng) | Vào trang `/kho-du-lieu` thấy số dòng hoặc tổng tiền sai ngay sau khi vừa nạp | 1) Mở trang **Kho dữ liệu**, khối **Lô nạp gần nhất**<br>2) Tìm dòng của file vừa nạp nhầm, bấm **Hoàn tác**, đọc số dòng sẽ bị xoá rồi xác nhận<br>3) Nạp lại đúng file qua ô kéo–thả ngay trên màn đó | ~10 giây tìm + hoàn tác |
